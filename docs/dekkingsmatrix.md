...
| TOP-019 | Pseudo-knoop: twee strengen gescheiden door een functieloze knoop, met identieke attributen (diameter, materiaal, stelseltype); zouden een streng moe… | W | Consistentie | geimplementeerd met test | functieloze_knopen, leidingen, mechanischeleidingen, netwerkknopen, vrijvervalrioolleidingen · BreedteLeiding, HoogteLeiding, MateriaalLeiding | — |
...
| TOP-022 | Hulpstuk verbindt minder leidingen dan zijn GWSW-functie voorschrijft. Het verwachte aantal volgt uit de `functie`-restrictie op de klasse in de onto… | F | Consistentie | geimplementeerd met test | hulpstukken, leidingen, mechanischeleidingen, vrijvervalrioolleidingen · — | — |
| TOP-023 | Hulpstuk verbindt meer leidingen dan zijn GWSW-functie voorschrijft; waarschijnlijk de verkeerde klasse gekozen (voor vier bestaat `Kruisstuk`). Zelf… | W | Consistentie | geimplementeerd met test | hulpstukken, leidingen, mechanischeleidingen, vrijvervalrioolleidingen · — | — |
...
| HGT-010 | Diameterverkleining in afvoerrichting (benedenstrooms kleiner dan bovenstrooms) | W | Plausibiliteit | geimplementeerd met test | netwerkknopen, vrijvervalrioolleidingen · BreedteLeiding, HoogteLeiding | — |
| HGT-011 | Overstortdrempel lager dan BOB aanvoerende streng of hoger dan maaiveld | F | Consistentie | geimplementeerd met test | vrijvervalrioolleidingen · BobEindpuntLeiding, Drempelbreedte, Drempelniveau, Maaiveldhoogte, Putdekselniveau · [klassen] drempel | — |
...
| ID | Omschrijving | Ernst | Dimensie | Status | Rollen · kenmerken | Toelichting |
| --- | --- | --- | --- | --- | --- | --- |
| NET-001 | Vuilwater- of gemengde streng zonder afvoerpad naar gemaal, overnamepunt of lozingspunt (bereikbaarheidsanalyse); een pompput telt niet als eindpunt,… | F | Consistentie | geimplementeerd met test | hulpstukken, lozingspunten, mechanischeleidingen, vrijvervalrioolleidingen · BobBeginpuntLeiding, BobEindpuntLeiding · [klassen] afvoer_eindpunt | — |
| NET-002 | Hemelwaterstreng zonder afvoerpad naar lozingspunt; een overnamepunt of gemaal telt ook als bestemming zodra de streng benedenstrooms in gemengd rioo… | F | Consistentie | geimplementeerd met test | hulpstukken, lozingspunten, mechanischeleidingen, vrijvervalrioolleidingen · BobBeginpuntLeiding, BobEindpuntLeiding · [klassen] afvoer_eindpunt | — |
...
| NET-005 | Stelseltype streng wijkt af van boven- en benedenstroomse buren | F | Consistentie | geimplementeerd met test | hulpstukken, vrijvervalrioolleidingen · BobBeginpuntLeiding, BobEindpuntLeiding · [klassen] stelseltypen | — |
| NET-006 | Ongeldige koppeling tussen stelseltypen: een gerichte koppeling (bovenstroom → benedenstroom, op de betrouwbare stroomrichting) die niet in de config… | W | Plausibiliteit | geimplementeerd met test | hulpstukken, vrijvervalrioolleidingen · BobBeginpuntLeiding, BobEindpuntLeiding, config:koppelregels · [klassen] stelseltypen, [klassen] vgs | — |
| NET-007 | IT-stelsel zonder drempel | F | Compleetheid | geimplementeerd met test | hulpstukken, infiltratieleidingen, overstortputten, vrijvervalrioolleidingen · BobBeginpuntLeiding, BobEindpuntLeiding · [klassen] drempel | — |
...
| RVZ-002 | Overstort zonder geregistreerd drempelniveau en/of drempelbreedte (Drempelniveau, Drempelbreedte), ook als het drempelonderdeel zelf ontbreekt; één m… | W | Compleetheid | geimplementeerd met test | overstortputten · Drempelbreedte, Drempelniveau · [klassen] drempel | — |
...
| RVZ-006 | Gemengd deelstelsel zonder enige externe overstort of BBB, óf zonder afvoereindpunt (gemaal of overnamepunt); het deelstelsel loopt door over een hul… | F | Plausibiliteit | geimplementeerd met test | bergbezinkvoorzieningen, hulpstukken, lozingspunten, mechanischeleidingen, netwerkknopen, overstortputten, vrijvervalrioolleidingen · config:snapping_tolerantie_m · [klassen] afvoer_eindpunt | — |
...
| RVZ-008 | BBB zonder ledigingsvoorziening of ledigingsroute terug naar het stelsel | W | Compleetheid | geimplementeerd met test | bergbezinkleidingen, bergbezinkvoorzieningen · — · [klassen] ledigingsvoorziening | — |
| RVZ-009 | BBB zonder nooduitlaat of externe overstortdrempel | W | Compleetheid | geimplementeerd met test | bergbezinkleidingen, bergbezinkvoorzieningen, overstortleidingen · Drempelbreedte, Drempelniveau · [klassen] drempel | — |
...
| RVZ-011 | Waking overstortdrempel kleiner dan 0,40 m (dekselniveau minus drempelniveau) | W | Plausibiliteit | geimplementeerd met test | — · Drempelbreedte, Drempelniveau, Maaiveldhoogte, Putdekselniveau · [klassen] drempel | — |
