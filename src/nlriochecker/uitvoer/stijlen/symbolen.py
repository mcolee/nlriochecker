...
zou staan. `vlakken.qml` en `gemengd_zonder_overstort.qml` blijven wel gewone bestanden:
die hebben een vaste structuur (drie soorten, respectievelijk een enkel vlaksymbool) die
niet met de data meeschaalt.
