...
Het register in `data/checkregister-gwsw-nulmeting-v0_9.md` is de bron van waarheid
...
def default_register_path() -> Path:
    ...
    return Path(__file__).resolve().parents[2] / "data" / "checkregister-gwsw-nulmeting-v0_9.md"
