...
Dit is met opzet een bladmodule: zij importeert niets uit `nlriochecker` en hangt
alleen aan de standaardbibliotheek. `nulbevinding` en de uitvoerlaag lezen `kort` en
`melding_id` hiervandaan, zonder daarmee een importkring te sluiten (issue #160). De
oude vindplaats `uitvoer/identiteit.py` blijft als re-export bestaan.
"""
