...
11. De dekkinganalyse op De Wolden (2026-08-16) meldt dat de vormen `Put_MateriaalPut_card` en `Rioolput_Maaiveldschematisering_card` alleen in Hyd meldingen opleveren en niet in MdsPlan of MdsProj, terwijl de dekkingclaim van ADM-004 die eisen aan Mds toeschrijft. Beide CFK's toetsen hetzelfde RDF-bestand, dus schone data verklaart het verschil niet. Herformuleren bij de volgende dekkinganalyse, of de claim beperken tot Hyd.
