...
2. Afgehandeld (2026-08-19). Alle vijf staan als instelbare waarde in `[drempels]` van de projectconfiguratie, met de standaard tussen haakjes: snapping-tolerantie (`snapping_tolerantie_m`, 0,10 m), min/max strenglengte (`minimale_strenglengte_m` 1 m en `maximale_strenglengte_m` 200 m, ATTR-008), minimaal verhang voor vuilwater en gemengd (`minimaal_verhang_promille`, 1,0 promille, HGT-007 -- een waarde, want HGT-007 geldt voor die twee stelseltypen samen), valput-drempel (`bob_sprong_m`, 0,25 m, HGT-009 en HGT-016) en de bufferafstanden van de EXT-checks (`ext_pand_buffer_m`, `ext_watergang_buffer_m`, `ext_putdeksel_afstand_m`, `ext_lozingspunt_water_afstand_m`, `ext_perceel_buffer_m`). Er staat geen drempel hardgecodeerd in de engine.
